...
const Order = ({cart}) => {
    ...
    return (
        <div className='text-black flex flex-col gap-6 mt-4'>
            ...
            <button className='flex items-center justify-center bg-red-600 text-white py-2 mx-4 rounded-md'><p className='pr-2'>Clear Cart</p><FontAwesomeIcon icon={faTrash} /></button>
